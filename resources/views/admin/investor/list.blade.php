...
<script src="{{ asset('js/admin/investor/list.js?v=').env('ASSET_V', 1) }}" type="text/javascript"></script>
        ...
        <table class="table table-bordered" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            foreach ($list as $l) {
              ...
              $buttons = '';
              $buttons .= '
              <a href="'.admin_url('investor/edit/'.$l->id).'" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
...
<div class="modal fade" id="mdl-delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-vcentered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="{{ url('admin-management/investor/delete') }}">
        {{ csrf_field() }}
