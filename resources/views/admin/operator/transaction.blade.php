...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-black"><i class="fas fa-user-secret"></i> Operator Transactions</h1>
    ...
    <div class="col-sm-12 col-md-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <form method="get" action="{{ admin_url('operator/transaction_list') }}" style="padding: 10px">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Operator ID</label>
                  <div class="col-sm-9">
              ...
              <div class="col-sm-12">
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <a href="{{ admin_url('operator/transaction_list') }}" class=" btn btn-lg btn-secondary">Clear</a>
                  </div>
                </div>
              </div>
            </div>
