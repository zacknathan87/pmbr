            ...
            <div class="result-content">
              ...
              <div class="result-body" v-if="this.pastGame.no">
                ...
                <div class="ball ball-8">
                  {{ this.pastGame.no.split(",")[7] }}
                </div>
                <div class="ball ball-9">
                  {{ this.pastGame.no.split(",")[8] }}
                </div>
                <div class="ball ball-10">
                  {{ this.pastGame.no.split(",")[9] }}
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="gameplay-content">
          <div v-if="betTypes.length">
            ...
            <div class="result-body" style="margin: -10px 0 25px">
              ...
              <div
                class="ball ball-8"
                :class="{ 'animated bounce infinite': animateBall8 }"
              >
                {{ this.runningNo }}
              </div>
              <div
                class="ball ball-9"
                :class="{ 'animated bounce infinite': animateBall9 }"
              >
                {{ this.runningNo }}
              </div>
              <div
                class="ball ball-10"
                :class="{ 'animated bounce infinite': animateBall10 }"
              >
                {{ this.runningNo }}
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    changeAnimateBall() {
      ...
      this.animateBall8 = this.currentBall == 8 ? true : false;
      this.animateBall9 = this.currentBall == 9 ? true : false;
      this.animateBall10 = this.currentBall == 10 ? true : false;
    },
    changeRunningNo() {
